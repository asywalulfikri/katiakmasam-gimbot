...
import static de.tobiasbielefeld.brickgames.SharedData.NUMBER_OF_GAMES;
import static de.tobiasbielefeld.brickgames.SharedData.TIMER_PAUSE;
import static de.tobiasbielefeld.brickgames.SharedData.distanceHeight;
import static de.tobiasbielefeld.brickgames.SharedData.distanceWidth;
import static de.tobiasbielefeld.brickgames.SharedData.edit;
import static de.tobiasbielefeld.brickgames.SharedData.gameView1;
import static de.tobiasbielefeld.brickgames.SharedData.gameView2;
import static de.tobiasbielefeld.brickgames.SharedData.getCurrentGame;
import static de.tobiasbielefeld.brickgames.SharedData.highScores;
import static de.tobiasbielefeld.brickgames.SharedData.input;
import static de.tobiasbielefeld.brickgames.SharedData.look;
import static de.tobiasbielefeld.brickgames.SharedData.mButtonPressed;
import static de.tobiasbielefeld.brickgames.SharedData.mButtonPressedCounter;
import static de.tobiasbielefeld.brickgames.SharedData.mainActivity;
import static de.tobiasbielefeld.brickgames.SharedData.menu;
import static de.tobiasbielefeld.brickgames.SharedData.metrics;
import static de.tobiasbielefeld.brickgames.SharedData.params;
import static de.tobiasbielefeld.brickgames.SharedData.savedData;
import static de.tobiasbielefeld.brickgames.SharedData.soundList;
import static de.tobiasbielefeld.brickgames.SharedData.sp;
import static de.tobiasbielefeld.brickgames.SharedData.vibrate;
import static de.tobiasbielefeld.brickgames.SharedData.vibration;
import static de.tobiasbielefeld.brickgames.SharedData.width;
import static de.tobiasbielefeld.brickgames.classes.Game.FIELD_HEIGHT;
import static de.tobiasbielefeld.brickgames.classes.Game.FIELD_HEIGHT_2;
import static de.tobiasbielefeld.brickgames.classes.Game.FIELD_WIDTH;
import static de.tobiasbielefeld.brickgames.classes.Game.FIELD_WIDTH_2;
    ...
    public void click1(View view) {
        switch (view.getId()) {
            case R.id.button_close:
                moveTaskToBack(true);
                Intent intent = new Intent(Main.this,InterestialLogout.class);
                startActivity(intent);
